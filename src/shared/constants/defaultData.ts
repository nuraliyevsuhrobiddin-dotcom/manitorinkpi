...
export const DEFAULT_DATA: ConstantsData = {
  ...
  PROJECTS: [
    {
      id: 1,
      name: 'Kvant hisoblashlar uchun yangi algoritmlar',
      type: 'Loyiha',
      direction: 'Fundamental',
      leaderName: 'Karimov Ali Valiyevich',
      leaderPosition: 'Professor-o‘qituvchi',
      departmentId: 6,
      facultyId: 1,
      totalFunding: 500,
      duration: 3,
    ...
    {
      id: 2,
      name: "Maktabgacha ta'limda raqamli pedagogika",
      type: 'Loyiha',
      direction: 'Amaliy',
      leaderName: 'Usmonova Sevara Karimovna',
      leaderPosition: 'Professor-o‘qituvchi',
      departmentId: 5,
      facultyId: 1,
      totalFunding: 250,
    ...
    {
      id: 3,
      name: "O'zbek adabiyotining yangi qirralari",
      type: 'Loyiha',
      direction: 'Innovatsion',
      leaderName: 'Qosimov Javohir Erkinovich',
      leaderPosition: 'Professor-o‘qituvchi',
      departmentId: 7,
      facultyId: 2,
      totalFunding: 150,
    ...
    {
      id: 4,
      name: "EduAI - Sun'iy intellektli repetitor",
      type: 'Startap',
      direction: 'Innovatsion',
      leaderName: 'Sodiqov Anvar',
      leaderPosition: 'Talaba',
      departmentId: 6,
      facultyId: 1,
      totalFunding: 50,
      duration: 1,
    ...
    {
      id: 5,
      name: 'Erasmus+ xalqaro grant',
      type: 'Grant',
      direction: 'Amaliy',
      leaderName: 'Nazarova Laylo Anvarovna',
      leaderPosition: 'Professor-o‘qituvchi',
      departmentId: 7,
      facultyId: 2,
      totalFunding: 1200,
    ...
    {
      id: 6,
      name: 'Pedagogika Tech Spinoff',
      type: 'Spinoff',
      direction: 'Innovatsion',
      leaderName: 'Abdullayeva Madina Zokirovna',
      leaderPosition: 'Professor-o‘qituvchi',
      departmentId: 1,
      facultyId: 1,
      totalFunding: 80,
  ...
  PROFESSORS: [
    ...
    },
    {
      ...
      position: 'Assistent',
      staffUnit: 0.5,
      employmentType: 'Ichki o‘rindosh',
      phone: '+998906789012',
    },
    {
      id: 7,
    ...
    },
    {
      ...
      position: 'O‘qituvchi',
      staffUnit: 1,
      employmentType: 'Tashqi o‘rindosh',
      phone: '+998913456789',
    },
    {
      id: 13,
  ...
  PLANS: [
    {
      ...
      year: 2026,
      planItems: [
        { type: 'publication', subType: 'Scopus Q1', count: 1 },
        { type: 'supervision', subType: 'DSc rahbarlik', count: 1 },
        { type: 'methodological_work', subType: 'Darslik', count: 1 },
      ],
    },
    {
      professorId: 2,
      year: 2026,
      planItems: [
        { type: 'publication', subType: 'Scopus Q2', count: 2 },
        { type: 'methodological_work', subType: 'Monografiya', count: 1 },
      ],
    },
    {
      professorId: 3,
      year: 2026,
      planItems: [
        { type: 'publication', subType: 'Scopus Q3', count: 1 },
        {
          type: 'international_activity',
          subType: 'Xorijiy stajirovka',
          count: 1,
        },
      ],
    },
    {
      ...
      year: 2026,
      planItems: [
        { type: 'publication', subType: 'Xalqaro konferensiya', count: 2 },
        { type: 'intellectual_property', subType: 'DGU', count: 2 },
      ],
    },
    {
      professorId: 5,
      year: 2026,
      planItems: [
        { type: 'project', subType: 'Bajarilayotgan xalqaro loyiha', count: 1 },
        { type: 'supervision', subType: 'DSc rahbarlik', count: 1 },
      ],
    },
    {
      ...
      planItems: [
        {
          ...
          subType: 'Respublika tanlovi 1-o‘rin',
          count: 2,
        },
        { type: 'publication', subType: 'OAK respublika', count: 3 },
      ],
    },
    {
      professorId: 7,
      year: 2026,
      planItems: [
        { type: 'publication', subType: 'Scopus Q2', count: 1 },
        { type: 'methodological_work', subType: 'Monografiya', count: 1 },
      ],
    },
    {
      professorId: 8,
      year: 2026,
      planItems: [{ type: 'publication', subType: 'Scopus Q1', count: 2 }],
    },
    {
      professorId: 9,
      year: 2026,
      planItems: [
        { type: 'supervision', subType: 'PhD rahbarlik', count: 2 },
        { type: 'publication', subType: 'OAK xalqaro', count: 2 },
      ],
    },
    {
      professorId: 10,
      year: 2026,
      planItems: [
        { type: 'publication', subType: 'Scopus Q3', count: 2 },
        { type: 'intellectual_property', subType: 'Patent', count: 1 },
      ],
    },
    {
      professorId: 11,
      ...
      planItems: [
        { type: 'methodological_work', subType: 'Darslik', count: 1 },
        { type: 'publication', subType: 'Scopus Q4', count: 2 },
      ],
    },
    {
      professorId: 12,
      year: 2026,
      planItems: [
        { type: 'project', subType: 'Davlat granti arizasi', count: 3 },
        { type: 'publication', subType: 'OAK respublika', count: 2 },
      ],
    },
    {
      professorId: 13,
      ...
      planItems: [
        {
          type: 'international_activity',
          subType: 'Xorijiy professor jalb qilish',
          count: 1,
        },
        { type: 'publication', subType: 'Scopus Q3', count: 1 },
      ],
    },
    {
      ...
      year: 2026,
      planItems: [
        { type: 'supervision', subType: 'Kengash a’zoligi', count: 1 },
        { type: 'publication', subType: 'Scopus Q1', count: 1 },
      ],
    },
    {
      ...
      planItems: [
        {
          type: 'student_achievement',
          subType: 'Xalqaro tanlov 1-o‘rin',
          count: 1,
        },
        { type: 'publication', subType: 'Xalqaro konferensiya', count: 2 },
      ],
    },
    {
      ...
      planItems: [
        { type: 'publication', subType: 'Scopus Q4', count: 2 },
        { type: 'methodological_work', subType: 'O‘quv qo‘llanma', count: 1 },
      ],
    },
    {
      professorId: 17,
      ...
      planItems: [
        ...
        {
          type: 'project',
          subType: 'Bajarilayotgan davlat loyihasi',
          count: 1,
        },
      ],
    },
    {
      ...
      professorId: 18,
      year: 2026,
      planItems: [{ type: 'publication', subType: 'OAK respublika', count: 4 }],
    },
    {
      id: 19,
      professorId: 19,
      ...
      planItems: [
        { type: 'publication', subType: 'Scopus Q3', count: 1 },
        { type: 'supervision', subType: 'PhD rahbarlik', count: 1 },
      ],
    },
    {
      id: 20,
  ...
  ACHIEVEMENTS: [
    ...
    },
    {
      ...
      quarter: 1,
      type: 'project',
      subType: 'Bajarilayotgan xalqaro loyiha',
      count: 1,
    },
    {
      id: 6,
  ...
  USERS: [{ id: 3, username: 'guest', role: 'guest' }],
  THESIS_DEFENSES: [
    {
      id: 1,
      lastName: 'Alimov',
      ...
      type: 'PhD',
      fieldOfScience: 'Pedagogika fanlari',
      thesisTopic: "Zamonaviy ta'limda innovatsion metodlar",
      supervisor: 'Karimov A.V.',
      defenseOrganization: 'Nizomiy nomidagi TDPU',
      councilNumber: 'DSc.03/30.12.2019.Ped.01.02',
      defenseDate: '2023-05-20',
    },
    {
      id: 2,
      lastName: 'Salimova',
      firstName: 'Dildora',
      patronymic: 'Erkinovna',
      departmentId: 7,
      facultyId: 2,
      specialty: "10.00.02 - O'zbek adabiyoti",
      type: 'DSc',
      fieldOfScience: 'Filologiya fanlari',
      thesisTopic: "XX asr o'zbek she'riyatida modernizm",
      supervisor: 'Qosimov J.E.',
      defenseOrganization:
        "O'zR FA O'zbek tili, adabiyoti va folklori instituti",
      councilNumber: 'DSc.02/30.12.2019.Fil.01.01',
