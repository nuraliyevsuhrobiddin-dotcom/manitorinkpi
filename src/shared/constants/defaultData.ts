...
export const DEFAULT_DATA: ConstantsData = {
  FACULTIES: [
    {
      id: 1,
      name: 'Pedagogika',
  ...
  EMPLOYMENT_TYPES: ['Asosiy', 'Ichki o‘rindosh', 'Tashqi o‘rindosh'],
  PROJECT_TYPES: ['Loyiha', 'Startap', 'Grant', 'Spinoff'],
  PROJECT_DIRECTIONS: ['Innovatsion', 'Amaliy', 'Fundamental'],
  PROJECT_LEADER_POSITIONS: ['Professor-o‘qituvchi', 'Ilmiy xodim', 'Talaba'],
  ...
  SCORING_SYSTEM: {
    ...
    international_activity: {
      'Xorijiy stajirovka': {
        score: 10,
        description:
          "Xorijiy mamlakatlarda o'tilgan malaka oshirish yoki stajirovka",
      },
      'Xorijiy professor jalb qilish': {
        score: 5,
        description:
          "O'quv jarayoniga xorijiy professor yoki mutaxassisni jalb qilish",
      },
    },
    student_achievement: {
  ...
  DEFENSE_TYPES: ['PhD', 'DSc', 'dotsent', 'professor'],
};
